...
class Wxpay
{
    ...
    /**
     * 统一下单
     * @param  array $order 订单 必须包含支付所需要的参数 body(产品描述)、total_fee(订单金额)、out_trade_no(商户订单号)、spbill_create_ip(用户端实际ip)、product_id(产品id)、trade_type(交易类型：JSAPI，NATIVE，APP)
     * 下单手册,如需其他参数直接order的数组中添加即可https://pay.weixin.qq.com/wiki/doc/api/app/app.php?chapter=9_1
     */
